...
pvc1 = psc.main_plot(fin_BAF3, r.path_target(), "BAF3_00080", fin_phrog, label="VC-1", fmt="svg")
pvc2 = psc.main_plot(fin_BAM6, r.path_target(), "BAM6_00020", fin_phrog, label="VC-2", fmt="svg")
pvc1.save(os.path.join(r.path_taret(), "pvc1.svg"))
