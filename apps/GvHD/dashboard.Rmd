...
# Load ITS
load(here("apps/GvHD/data/processed/pseq_ITS.RData"))
...
# Correlation
load(here("apps/GvHD/data/processed/MOFAobject.RData"))
...
# update_cor_sel_bacVir <- reactive({
#   cor_sel <- b2v.cor[rowSums(abs(b2v.cor)>input$cor)>0,]
#   newnames <- set_names(pseq_16s_sel$Genus, rownames(pseq_16s_sel))
#   colnames(cor_sel) <- newnames[colnames(cor_sel)]
#   return(cor_sel)
# })

# update_cor_sel_metVir <- reactive({
#   cor_sel <- b2v.cor[rowSums(abs(b2v.cor)>input$cor)>0,]
#   newnames <- set_names(pseq_16s_sel$Genus, rownames(pseq_16s_sel))
#   colnames(cor_sel) <- newnames[colnames(cor_sel)]
#   return(cor_sel)
