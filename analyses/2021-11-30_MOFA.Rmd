...
fpath_metadata = here("hpc/processed/metadata.tsv")
fpath_metabolites_BileAcid <- here("hpc/collab/2021-12-08_metabolites_email/MRI + UKR Bile acid dry feces_normalized.xlsx")
fpath_metabolites_SCFA <- here("hpc/collab/2021-12-08_metabolites_email/MRI + UKR SCFA dry feces_normalized.xlsx")
...
load(here("hpc/processed/pseq_16s.RData"))
load(here("hpc/processed/pseq_ITS.RData"))
load(here("hpc/processed/pseq_vir.RData"))
nrow(pseq_vir@otu_table@.Data)


# phamb
dir_phamb <- here("hpc/hms/virmerge/phamb/results/")
...
load(here("data/processed/MOFAobject.RData"))

#MOFAobject@cache[["variance_explained"]]

# After model ﬁtting, we seleted top 10 factors with minimum of 1.14% average variance explained across all modalities.
r2 <- calculate_variance_explained(MOFAobject)[["r2_per_factor"]]
r2_mean <- rowMeans(sapply(r2, rowMeans))
r2_mean
min(r2_mean)
```
